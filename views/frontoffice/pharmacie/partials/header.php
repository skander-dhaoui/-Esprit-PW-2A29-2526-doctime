...
<head>
    ...
    <style>
        /* ── Styles originaux du module pharmacie ─────────────── */
        ...
        /* Header pharmacie plein largeur (style original) */
        .pharma-header {
            background: linear-gradient(135deg, #2A7FAA 0%, #4CAF50 100%);
            color: white;
            padding: 50px 0;
        ...
        /* Footer pharmacie (style original) */
        .pharma-footer {
            background: #1a2035;
            color: white;
            text-align: center;
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= $activePage === 'pharmacie' ? 'active' : '' ?>"
                       href="index.php?page=pharmacie">
                        <i class="fas fa-pills me-1"></i>Pharmacie
                    </a>
                </li>
