        ...
        <div class="row g-0">
            ...
            <div class="col-lg-7">
                <div class="detail-content">
                    ...
                    <div class="detail-price mb-3"><?= number_format((float)($produit['prix'] ?? 0), 2) ?> TND</div>
                    ...
                    <div class="small text-secondary">Reference: <strong><?= htmlspecialchars($produit['slug']) ?></strong></div>
                    <?php endif; ?>
                    ...
                    <form method="POST" action="index.php?page=mes_commandes&action=create" id="formCommandeFront" novalidate>
                        ...
                        <div class="mt-3 d-flex justify-content-between align-items-center">
                            <small class="text-muted">Total estime: <strong><?= number_format((float)$produit['prix'], 2) ?> TND</strong> (hors TVA, quantite 1)</small>
