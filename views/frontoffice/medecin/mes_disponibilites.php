                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="heure_debut" id="heure_debut" class="form-control <?= isset($errors['heure_debut']) ? 'error' : '' ?>" 
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="heure_fin" id="heure_fin" class="form-control <?= isset($errors['heure_fin']) ? 'error' : '' ?>" 
