...
<head>
    ...
    <title>Modifier un rendez-vous - Valorys</title>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0"><i class="fas fa-edit me-2"></i>Modifier le rendez-vous</h4>
                </div>
                <div class="card-body">
                    ...
                    <form method="POST" action="index.php?page=medecin_rendezvous&action=update&id=<?= $rdv['id'] ?>">
                        <div class="mb-3">
...
const currentHeure = '<?= $rdv['heure_rendezvous'] ?>';
            ...
            .then(data => {
                ...
                if (data.slots && data.slots.length) {
                    data.slots.forEach(slot => {
                        ...
                        if (slot === currentHeure) option.selected = true;
