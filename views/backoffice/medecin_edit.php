        ...
        <form method="POST" action="index.php?page=medecins_admin&action=edit&id=<?= $medecin['id'] ?? '' ?>">
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="prenom" class="form-control" value="<?= htmlspecialchars($medecin['prenom'] ?? '') ?>" required>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 mb-3">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="tel" name="telephone" class="form-control" value="<?= htmlspecialchars($medecin['telephone'] ?? '') ?>">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 mb-3">
