...
<div class="bo-create-page">
    ...
    <div class="bo-create-header mb-4">
        <h1 class="bo-create-title">
            Modifier : <?= htmlspecialchars(trim(($old['prenom'] ?? '') . ' ' . ($old['nom'] ?? ''))) ?>
        </h1>
    ...
    <div class="card bo-create-card shadow-sm">
        ...
        <div class="card-body">
            <form class="bo-create-form"
                  action="index.php?page=participations&amp;action=edit&amp;id=<?= (int)($old['id'] ?? 0) ?>" method="POST"
                    ...
                    <div class="col-12">
                        ...
                        <select id="statut" name="statut"
                            ...
                            foreach ($statuts as $st): ?>
                                <option value="<?= htmlspecialchars($st, ENT_QUOTES, 'UTF-8') ?>" <?= ($old['statut'] ?? '') === $st ? 'selected' : '' ?>>
                                    <?= htmlspecialchars($statutLabels[$st] ?? $st, ENT_QUOTES, 'UTF-8') ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
