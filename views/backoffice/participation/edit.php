<?php $pageTitle = 'Modifier la Participation'; ?>
<?php require __DIR__ . '/../layout_header.php'; ?>

<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h5 class="mb-0 fw-semibold">Modifier : <?= htmlspecialchars(($old['prenom'] ?? '').' '.($old['nom'] ?? '')) ?></h5>
...
<div class="card">
    <div class="card-header py-3">
        <h6 class="mb-0"><i class="bi bi-person-lines-fill me-2"></i>Informations du participant</h6>
    </div>
    <div class="card-body">
        <form action="index.php?controller=participation&action=update" method="POST"
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="nom" name="nom"
                           ...
                           data-validate="required|minlength:2|maxlength:100" data-label="Nom">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="prenom" name="prenom"
                           ...
                           data-validate="required|minlength:2|maxlength:100" data-label="Prénom">
                ...
                <div class="col-md-6">
                    ...
                    <select id="evenement_id" name="evenement_id"
                            ...
                            data-validate="required" data-label="Événement">
