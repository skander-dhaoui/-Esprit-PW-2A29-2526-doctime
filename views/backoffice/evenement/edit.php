...
<div class="bo-create-page">
    ...
    <div class="bo-create-header mb-4">
        <h1 class="bo-create-title">Modifier : <?= htmlspecialchars($old['titre'] ?? '') ?></h1>
    ...
    <div class="card bo-create-card shadow-sm">
        ...
        <div class="card-body">
            <form class="bo-create-form"
                  action="index.php?page=evenements_admin&amp;action=edit&amp;id=<?= (int)($old['id'] ?? 0) ?>" method="POST"
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-text">Doit être au moins égale à la date de début.</div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="file" id="event_image" class="form-control" accept="image/jpeg,image/png,image/gif,image/webp" disabled aria-describedby="event-image-help-edit">
                        <div id="event-image-help-edit" class="form-text">Formats acceptés : JPEG, PNG, GIF, WebP — modification fichier prévue ultérieurement.</div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="statut" name="statut"
                            ...
                            foreach ($statuts as $st): ?>
                                <option value="<?= htmlspecialchars($st) ?>" <?= ($old['statut'] ?? '') === $st ? 'selected' : '' ?>>
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="sponsor_id" name="sponsor_id" class="form-select">
                            ...
                            <?php foreach ($sponsors as $sp): ?>
                                <option value="<?= (int)$sp['id'] ?>" <?= ((string)($old['sponsor_id'] ?? '')) === (string)$sp['id'] ? 'selected' : '' ?>>
