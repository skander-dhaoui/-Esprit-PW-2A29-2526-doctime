...
<div class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="index.php?page=evenements_avance_admin" class="<?= $current_page === 'evenements_avance_admin' ? 'active' : '' ?>">
            <i class="fas fa-chart-bar"></i> Événements Avancé
        </a>
        <a href="index.php?page=participations_admin" class="<?= $current_page === 'participations_admin' ? 'active' : '' ?>">
            <i class="fas fa-people-service"></i> Participations
        </a>
