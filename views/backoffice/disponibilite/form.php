...
<div class="container mt-4">
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="index.php?page=disponibilites_admin&action=<?= isset($disponibilite) ? 'edit&id=' . $disponibilite['id'] : 'create' ?>">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="error-container" id="medecin_id-error"></div>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="error-container" id="jour_semaine-error"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="error-container" id="heure_debut-error"></div>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="error-container" id="heure_fin-error"></div>
                    </div>
                </div>
                ...
                <div class="mb-3 form-check">
                    <input type="checkbox" name="actif" class="form-check-input" id="actif" value="1" <?= (isset($old['actif']) && $old['actif'] == 1) || (isset($disponibilite) && $disponibilite['actif'] == 1) ? 'checked' : '' ?>>
