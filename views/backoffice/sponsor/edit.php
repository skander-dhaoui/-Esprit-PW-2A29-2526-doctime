<?php $pageTitle = 'Modifier le sponsor'; ?>
...
<div class="bo-create-page">
    ...
    <div class="bo-create-header mb-4">
        <h1 class="bo-create-title">Modifier : <?= htmlspecialchars($old['nom'] ?? '') ?></h1>
    ...
    <div class="card bo-create-card shadow-sm">
        ...
        <div class="card-body">
            <form class="bo-create-form"
                  action="index.php?page=sponsors_admin&amp;action=edit&amp;id=<?= (int)($old['id'] ?? 0) ?>" method="POST"
