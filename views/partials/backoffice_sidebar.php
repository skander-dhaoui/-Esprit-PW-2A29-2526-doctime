...
if (!function_exists('bo_nav_carte')) {
    /** Carte : page=carte ; métiers : action=metiers */
...
?>
<div class="sidebar sidebar-bo-light">
    <div class="sidebar-brand">
        <div class="brand-icon"><i class="fas fa-heart-pulse"></i></div>
        <h4>Valorys</h4>
        <small>Gestion plateforme</small>
    </div>
    <nav class="sidebar-nav">
        ...
        <a class="<?= trim(bo_nav_carte(true)) ?>" href="index.php?page=carte&action=metiers"><i class="fas fa-robot"></i><span>IA Métiers créatifs</span></a>
        ...
        <a class="<?= trim(bo_nav_active(['articles_admin', 'blog', 'blog_public'])) ?>" href="index.php?page=articles_admin"><i class="fas fa-blog"></i><span>Blog &amp; articles</span></a>
