...
INSERT INTO events (titre, slug, description, contenu, date_debut, date_fin, lieu, adresse, capacite_max, places_restantes, image, prix, status, created_at, updated_at)
VALUES
('Congrès de Cardiologie', 'congres-cardiologie', 'Une journée dédiée aux avancées en cardiologie.', 'Programme complet avec orateurs nationaux et internationaux.', '2026-07-20 09:00:00', '2026-07-20 17:00:00', 'Centre de Conférences Tunis', 'Rue de la Santé, Tunis', 120, 120, NULL, 180.00, 'à venir', NOW(), NOW()),
('Atelier Dermatologie & Peau', 'atelier-dermatologie-peau', 'Atelier pratique sur le diagnostic et les traitements de la peau.', 'Sessions interactives et démonstrations de soins dermatologiques.', '2026-08-14 10:00:00', '2026-08-14 15:00:00', 'Institut Dermatologique', 'Avenue Habib Bourguiba, La Marsa', 80, 80, NULL, 120.00, 'à venir', NOW(), NOW()),
('Forum Esthétique Médicale', 'forum-esthetique-medicale', 'Forum professionnel sur les innovations en médecine esthétique.', 'Conférences et tables rondes autour des techniques esthétiques.', '2026-09-05 09:30:00', '2026-09-05 16:30:00', 'Palais des Expositions', 'Sousse, Tunisie', 100, 100, NULL, 150.00, 'à venir', NOW(), NOW());
...
INSERT INTO sponsors (nom, email, telephone, secteur, budget, description, logo, site_web, statut, niveau, created_at, updated_at)
VALUES
